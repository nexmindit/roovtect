    ...
    <>
      ...
      <section className="bg-[#f7f7f8] text-[#1f1f25] py-16 md:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto space-y-20">
          {/* Section 3.2 - Custom Metal & Stainless Works */}
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] items-stretch">
            ...
            <div className="grid gap-4">
              <div className="relative h-72 md:h-96 w-full overflow-hidden rounded-[32px] shadow-lg">
                <Image
                  src="/feature1.png"
              ...
              <div className="relative h-56 md:h-72 w-full overflow-hidden rounded-[32px] shadow-lg">
                <Image
                  src="/feature2.jpg"
                  alt="Stainless architectural detail"
                  fill
                  className="object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
